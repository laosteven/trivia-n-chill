...
<a
  ...
  class="fixed bottom-4 left-4 bg-gray-800/20 hover:bg-gray-700/20 text-white px-4 py-2 rounded-lg shadow-lg transition-colors flex items-center gap-2 z-50"
